m4_dnl The easiest way to edit this configuration is to configure within `top`
m4_dnl then save the configuration with W and overwrite this.
...
Def	fieldscur=¥&K¨³´»½@·º¹56ÄFÅ')*+,-./0128<>?ABCGHIJLMNOPQRSTUVWXYZ[\]^_`abcdefghij
	winflags=162612, sortindx=18, maxtasks=0, graph_cpus=1, graph_mems=2
